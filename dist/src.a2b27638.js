...
var deleteFormImcompleteList = function deleteFormImcompleteList(target) {
...
var createIncompleteList = function createIncompleteList(text) {
  //<li>生成
  var li = document.createElement("li"); //<div class="list-low">生成

  var div = document.createElement("div");
  div.className = "list-row"; //<p>生成

  var todo = document.createElement("p");
  todo.innerText = text; //<button>(完了)生成

  var completeButton = document.createElement("button");
  completeButton.innerText = "完了";
  completeButton.addEventListener("click", function () {
    //押された完了ボタンの親タグ(li)を未完了リストから削除
    deleteFormImcompleteList(completeButton.closest("li")); //完了リストに追加する要素

    var addTarget = completeButton.parentNode; //ToDO内容テキストを取得

    var text = addTarget.firstElementChild.innerText; //div以下を初期化(使いまわし)

    addTarget.textContent = null; //pタグ生成

    var todo = document.createElement("p");
    todo.innerText = text; //buttonタグ生成
  ...
  li.appendChild(div); //本文のタグの中に入れる
